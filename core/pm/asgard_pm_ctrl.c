...
static ssize_t asgard_hb_ctrl_proc_write(struct file *file,
...
static ssize_t asgard_cpumgmt_write(struct file *file,
...
static ssize_t asgard_cluster_id_write(struct file *file,
                                     const char __user *user_buffer, size_t count,
                                     loff_t *data)
{
    int err;
...
static ssize_t asgard_hbi_write(struct file *file,
					const char __user *buffer, size_t count,
					loff_t *data)
{
	int err;
...
static ssize_t asgard_ww_write(struct file *file,
					const char __user *buffer, size_t count,
					loff_t *data)
{
	int err;
...
static ssize_t asgard_payload_write(struct file *file,
				   const char __user *user_buffer, size_t count,
				   loff_t *data)
{
	int ret = 0;
...
static ssize_t asgard_target_write(struct file *file,
				  const char __user *user_buffer, size_t count,
				  loff_t *data)
{
	int err;
...
static ssize_t asgard_test_ctrl_write(struct file *file,

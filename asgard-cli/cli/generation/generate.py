...
@click.command()
@click.option('--entries', default=1000)
@click.option('--min', default=16)
@click.option('--max', default=32)
@click.option('--output', default='generated_data.json')
def generateData(entries, min, max, output):
